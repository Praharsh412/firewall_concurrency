...
*/
void Server::AcceptAndDispatch(vector<string> Ip, vector<int> ports, vector<string> censored) {
...
//Static
void *Server::HandleClient(void *args, vector<string> Ip, vector<int> ports, vector<string> censored) {
